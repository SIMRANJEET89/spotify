...
// const API_KEY = "AIzaSyCYhjr1ZRYT0wL5xY-fYK2tPVK6GDau0jw";
// const FOLDER_ID = "1cUg1-IrHWA8b-bT1i9nrJw2SkYDPv6Kf";

const API_KEY = "AIzaSyCYhjr1ZRYT0wL5xY-fYK2tPVK6GDau0jw"; // Aapki API Key
const FOLDER_ID = "1cUg1-IrHWA8b-bT1i9nrJw2SkYDPv6Kf"; // Songs folder ka ID
...
async function getSongsFromFolder() {
    ...
    try {
        ...
        data.files.forEach(file => {
            const songUrl = `https://drive.google.com/uc?export=download&id=${file.id}`;
            console.log(`Song: ${file.name} → ${songUrl}`);
        });
    } catch (error) {
...
// }
 ...
 const playMusic = (track, pause=false) =>{
    ...
    async function displayAlbums() {
        let a = await fetch(`AIzaSyCYhjr1ZRYT0wL5xY-fYK2tPVK6GDau0jw`)
        let response = await a.text();
